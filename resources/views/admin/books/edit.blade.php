            ...
            <div class="container-fluid" style="padding:0 2rem 1.5rem 2rem;">
                <div class="card">
                    <div class="card-header bg-white">
                        <h5 class="fw-semibold mb-0">Edit Buku</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div class="text-center">
                                        <img id="coverPreview"
                                             src="{{ $book->cover_url ? asset('storage/'.$book->cover_url) : 'https://via.placeholder.com/300x400' }}"
                                             class="img-fluid rounded mb-3"
                                             alt="Book Cover" style="max-height: 300px;">
                                        <div class="mb-3">
                                ...
                                <div class="col-md-8">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="genre" value="{{ $book->genre }}" placeholder="Contoh: Romance, Horror, dll">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Jumlah Halaman</label>
                                            <input type="number" class="form-control" name="pages" value="{{ $book->pages }}" placeholder="Masukkan jumlah halaman">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" name="synopsis" rows="4" required>{{ $book->synopsis }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
